...
export const UserProfilePage: React.FC = () => {
  ...
  if (loading) {
    return (
      <UserLayout headerTitle="Profil Pengguna">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-red-100 dark:border-red-900/30 shadow-sm p-5">
              ...
              <p className="text-xs text-slate-500 mb-4 leading-relaxed">
                Keluar dari sesi ini akan mengharuskan Anda untuk login kembali
                untuk mengakses booking.
              </p>
              <button
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <div className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                ...
                <span className="text-xs text-slate-400">1 hari yang lalu</span>
              </div>
            </div>
          </div>
        </div>
