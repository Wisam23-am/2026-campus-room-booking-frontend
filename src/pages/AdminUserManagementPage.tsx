...
export const AdminUserManagementPage: React.FC = () => {
  ...
  const getRoleBadge = (role: number) => {
    switch (role) {
      case 1: // Admin
        return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900/40 dark:text-purple-200">Admin</span>;
      case 0: // User
        return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-200">User</span>;
      default:
        return null;
    }
  };
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 min-h-screen font-display antialiased">
      <div className="flex h-screen overflow-hidden">
        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-background-light dark:bg-background-dark relative">
          <header className="h-16 bg-surface-light dark:bg-surface-dark border-b border-neutral-light dark:border-neutral-dark flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-sm z-10">
            <h1 className="text-xl font-bold text-slate-800 dark:text-white">Manajemen Pengguna</h1>
            <div className="flex items-center gap-3">
              <button aria-label="Notifications" className="p-2 text-slate-400 hover:text-primary rounded-full hover:bg-primary/5 transition-colors relative">
            ...
            <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-surface-light dark:bg-surface-dark p-4 rounded-xl border border-neutral-light dark:border-neutral-dark shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{userCount}</h3>
                </div>
                <div className="bg-surface-light dark:bg-surface-dark p-4 rounded-xl border border-neutral-light dark:border-neutral-dark shadow-sm">
              ...
              <div className="bg-surface-light dark:bg-surface-dark p-4 rounded-xl border border-neutral-light dark:border-neutral-dark shadow-sm">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                  <div className="md:col-span-6">
                    <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Cari User</label>
                    <input
                  ...
                  <div className="md:col-span-4">
                    <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Peran</label>
                    <select
                      className="block w-full rounded-lg border-neutral-light dark:border-neutral-dark bg-slate-50 dark:bg-slate-900/50 text-sm focus:border-primary focus:ring-primary dark:text-white shadow-sm"
                      value={roleFilter ?? ""}
              ...
              <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-neutral-light dark:border-neutral-dark overflow-hidden">
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12">
                    <span className="material-icons-round text-slate-300 text-6xl">people</span>
                    ...
                    <div className="overflow-auto flex-1">
                      <table className="min-w-full divide-y divide-neutral-light dark:divide-neutral-dark">
                        <thead className="bg-slate-50 dark:bg-slate-800/50 sticky top-0 z-10">
                          <tr>
                            <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">ID</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Nama & Email</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Peran</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Terdaftar</th>
