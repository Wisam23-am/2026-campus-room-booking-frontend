              ...
              <div className="px-4 py-5 sm:p-6">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3 flex-1 md:flex md:justify-between">
                      <p className="text-sm text-blue-700 dark:text-blue-300">
                        Kata sandi terakhir diubah 3 bulan yang lalu.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="max-w-lg">
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        type="password"
                      />
                      <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer hover:text-primary transition-colors group">
                  ...
                  <div className="max-w-lg">
                    ...
                    <div className="mt-3">
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 flex gap-1 overflow-hidden">
                        ...
                        <div className="bg-primary h-1.5 w-1/3 rounded-full"></div>
                        <div className="bg-gray-300 dark:bg-gray-600 h-1.5 w-1/3 rounded-full"></div>
                      </div>
                      <ul className="mt-2 text-xs text-text-muted space-y-1 list-disc pl-4">
                        <li className="text-green-600 dark:text-green-400">
                          Minimal 8 karakter
                        </li>
                        <li className="">Mengandung huruf besar &amp; kecil</li>
                        <li className="">Mengandung angka atau simbol</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="px-4 py-4 sm:px-6 bg-gray-50 dark:bg-black/20 border-t border-border-light dark:border-border-dark flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                    ...
                    <button
                      className="w-full sm:w-auto inline-flex justify-center items-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary sm:text-sm"
                      type="submit"
                    >
                      Perbarui Kata Sandi
                    </button>
