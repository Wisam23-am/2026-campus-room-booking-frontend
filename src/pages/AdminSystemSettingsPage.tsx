...
export const AdminSystemSettingsPage: React.FC = () => {
  return (
    <AdminLayout headerTitle="Pengaturan Sistem">
      <div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-[#15202b]">
              ...
              <div className="p-6">
                <div className="max-w-md">
                  ...
                  <p className="mt-2 text-sm bg-blue-50 dark:bg-slate-800/50 p-3 rounded-lg border border-blue-100 dark:border-slate-700 text-blue-800 dark:text-blue-300 flex gap-2">
                    <span className="material-icons text-sm mt-0.5">info</span>
                    Mahasiswa tidak akan bisa membuat reservasi melebihi durasi
                    ini dalam satu kali booking.
                  </p>
                </div>
              </div>
            </div>
